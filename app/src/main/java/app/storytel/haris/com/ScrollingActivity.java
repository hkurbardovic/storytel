//package app.storytel.haris.com;
//
...
//                List<PostSchema> posts = getPosts();
//                List<Photo> photos = getPhotos();
//                return new PostAndImages(posts, photos);
//            }
//
//            private List<PostSchema> getPosts()
//            {
//                List<PostSchema> posts = null;
...
//                        PostSchema[] array = new Gson().fromJson(result, PostSchema[].class);
